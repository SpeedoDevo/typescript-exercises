...
function requestAdmins(
  callback: (response: Response<Admin[], string>) => void
) {
  callback({
    status: "success",
    data: admins,
...
function requestUsers(callback: (response: Response<User[], string>) => void) {
  callback({
    status: "success",
    data: users,
  });
...
function requestCurrentServerTime(
  callback: (response: Response<number, string>) => void
) {
  callback({
    status: "success",
    data: Date.now(),
